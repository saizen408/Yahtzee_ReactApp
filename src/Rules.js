...
const twos = new TotalOneNumber({ val: 2, description: '2 pointer per 2' });
const threes = new TotalOneNumber({ val: 3, description: '3 pointer per 3' });
const fours = new TotalOneNumber({ val: 4, description: '4 pointer per 4' });
const fives = new TotalOneNumber({ val: 5, description: '5 pointer per 5' });
const sixes = new TotalOneNumber({ val: 6, description: '6 pointer per 6' });
